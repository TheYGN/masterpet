...
> עודכן: 2026-05-26 — סנכרון תוכן מלא ל-`pet_platform_tree.excalidraw` (תוויות + Roadmap + 4 פריטים חסרים נוספו בקופסה צהובה בתחתית הקנבס לסידור ויזואלי ידני). מכאן ואילך: כל שינוי בקובץ אחד מחייב עדכון בשני (חוק ב-CLAUDE.md).
